---
title: "Cohere - Tales of the Call Center Subreddit Report"
output:
  pdf_document:
    toc: no
  html_document:
...
# Load the CSV files
data <- read_csv("tfcc_top_20_summaries_of_summaries_cohere.csv")
comments_data <- read_csv("tfcc_comments_summaries_of_summaries_cohere.csv")
summary_data <- read_csv("tfcc_summary_details_cohere.csv")
